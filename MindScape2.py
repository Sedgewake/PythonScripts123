...
from tkinter import simpledialog, Toplevel, Text, Scrollbar, messagebox, colorchooser, filedialog
...
class Node:
    ...
    def _bind_events(self):
        for item in (self.rect, self.label, self.note_button, self.color_button, self.image_button):
        ...
        self.canvas.tag_bind(self.image_button, "<Button-1>", self.pick_image)
